 ...
 */
public class OutputComparedToRTMAfterFilterWindow {
    ...
    public void testEqualPredicateFixedValue() {
        ...
        // FIXME: Andreas Morgen, Insertion of "Filter" Operator let the test be negative.
        // Refer to source file OutputComparedWithWindowToRTM.testEqualPredicateFixedValue which is the same
        // test as this expect that Filter runs before correlator in this test. The reference test passes successfully.
        // Is it checked, that each tuple is processed as expected in Filter?
        ...
        rtm.createQuery(new Filter("Filter", new Stream(stream1, new TimeWindow(10)), new True()));
        rtm.createQuery(new Correlator("Cor", new Stream("Filter"), refLeft, new Stream(stream2,new TimeWindow(10)), refRight, joinCondition));
        ...
        nativeEngine.createQuery(new Filter("Filter", new Stream(stream1,new TimeWindow(10)), new True()));
        nativeEngine.createQuery(new Correlator("Cor", new Stream("Filter"), refLeft, new Stream(stream2,new TimeWindow(10)), refRight, joinCondition));
    ...
    public void testEqualPredicateFixedValue2() {
        ...
        // FIXME: Andreas Morgen, Insertion of "Filter" Operator let the test be negative.
        // Refer to source file OutputComparedWithWindowToRTM.testEqualPredicateFixedValue2 which is the same
        // test as this expect that Filter runs before correlator in this test. The reference test passes successfully.
        // Is it checked, that each tuple is processed as expected in Filter?
    ...
    public void testBetweenPredicateFixedValue2() {
        ...
        // TODO: Andreas Morgen, is there an illegal data type change inside filter operator?
        // FIXME: It seems, that "Native Filter" changes data type Integer to Long, so that following compare for given join condition inside "Native Correlator" leads to an ClassCastException.
        // To repeat error, try
        // Replace
        //      nativeEngine.createQuery(new Correlator("Cor", new Stream("Filter"), refLeft, new Stream(stream2,new TimeWindow(10)), refRight, joinCondition));
        // with
        ...
        // which skips the filter. Then the code works as excepted.
    ...
    public void testEqualPredicateReference() {
        ...
        // FIXME: Andreas Morgen, Insertion of "Filter" Operator let the test be negative.
        // Refer to source file OutputComparedWithWindowToRTM.testEqualPredicateReference which is the same
        // test as this expect that Filter runs before correlator in this test. The reference test passes successfully.
        // Is it checked, that each tuple is processed as expected in Filter?
