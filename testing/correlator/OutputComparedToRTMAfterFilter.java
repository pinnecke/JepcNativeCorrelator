 ...
 */
public class OutputComparedToRTMAfterFilter {
    ...
    public void testEqualPredicateFixedValue() {
        ...
        rtm.createQuery(new Filter("Filter", new Stream(stream1), new True()));
        rtm.createQuery(new Correlator("Cor", new Stream("Filter"), refLeft, new Stream(stream2), refRight, joinCondition));
        ...
        nativeEngine.createQuery(new Filter("Filter", new Stream(stream1), new True()));
        nativeEngine.createQuery(new Correlator("Cor", new Stream("Filter"), refLeft, new Stream(stream2), refRight, joinCondition));
